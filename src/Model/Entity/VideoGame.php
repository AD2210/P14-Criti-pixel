...
class VideoGame
{
    ...
    #[Column]
    /**
     * @var int|null Auto-generated by Doctrine
     *
     * @phpstan-ignore-next-line reason: propriété généré automatiquement
     */
    private ?int $id = null;
    ...
    #[Slug(fields: ['title'])]
    /**
     * Slug généré automatiquement (Gedmo Sluggable).
     *
    ...
    /**
     * Met à jour la date lors des changements de fichier/image.
     *
     * @phpstan-ignore-next-line reason: propriété seulement écrite par le domaine
     */
