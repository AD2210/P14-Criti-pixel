...
final class AddReviewTest extends FunctionalTestCase
{
    ...
    /**
     * Test si on affiche le formulaire de review lorsque user logué
     *
     * @return void
     */
    ...
    public function testShouldRedirectAfterSubmitForm(): void
    {
        ...
        // on vérifie l'abscence du formulaire après la redirection (1 seule review / user / jeu)
        self::assertTrue($crawler->filter('form')->count() == 0);

        $this->ensureReviewNotPublishedByUser('user+0@email.com'); //@todo plus necessaire avec dama
    }
